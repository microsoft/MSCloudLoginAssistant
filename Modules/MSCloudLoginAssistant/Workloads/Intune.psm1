function Connect-MSCloudLoginIntune
{
    ...
    try
    {
        Connect-MSGraph -Credential $CloudCredential
    }
    catch
    {
        ...
        {
            Write-Verbose "The AzureAD Application {d1ddf0e4-d672-4dae-b554-9d5bdfd93547} has not bee granted consent. Launching an interactive prompt to request consent.'"
