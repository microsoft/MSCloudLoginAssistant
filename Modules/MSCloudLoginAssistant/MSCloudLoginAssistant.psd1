...
@{
    ...
    CmdletsToExport        = @('Test-MSCloudLogin', `
                                'Connect-M365Tenant', `
                               'Invoke-MSCloudLoginMicrosoftGraphAPI')
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            Tags       = 'Azure', 'Az', 'AzureAD', 'Cloud', 'Office365', 'PnP', 'MicrosoftTeams', "ExchangeOnline", "SharePointOnline", "Microsoft365DSC"
