...
@{
    ...
    NestedModules          = @(
        ...
        'Workloads\SharePointOnlineREST.psm1',
    ...
    CmdletsToExport        = @('Connect-M365Tenant')
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            Tags       = 'EntraId', 'Cloud', 'Office365', 'PnP', 'MicrosoftTeams', "ExchangeOnline", "SharePointOnline", "Microsoft365DSC", "Fabric"
